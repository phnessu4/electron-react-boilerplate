...
- Renamed `app/electron/bundle.js` to `app/electron/renderer.prod.js` for consistency
...
- **Renamed `./app/electron/main.development.js` => `./app/electron/main.{dev,prod}.js`:** [#963](https://github.com/electron-react-boilerplate/electron-react-boilerplate/pull/963)
